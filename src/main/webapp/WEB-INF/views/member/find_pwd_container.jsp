    ...
    <div class="glamping-N44" data-bid="gtlTWpIoop">
      <div class="contents-inner">
        <div class="contents-container">
          <div class="textset">
            <h2 class="textset-tit">비밀번호찾기</h2>
                ...
                <form >
                  <div class="contents-form">
                    <div class="inputset inputset-round  input_name">
                      <div>이름</div>
                      <input type="text" name="mem_name" class="inputset-input form-control" aria-label="내용" placeholder="등록된 이름을 입력해주세요." required="" value="">
                    </div>
                    <div class="inputset inputset-round  input_name">
                      <div>아이디</div>
                      <input type="text" name="mem_id" class="inputset-input form-control" aria-label="내용" placeholder="등록된 아이디를 입력해주세요." required="" value="">
                    </div>
                    ...
                    <div class="contents-btnset">
                      <input id="btn_pwd" class="btnset btnset-round " type="button" onclick="change_pwd(this.form);" value="비밀번호 초기화">
                    </div>
                  </div>
                </form>
